    ...
    <section id="contact" className="py-16 lg:py-30">
      <div className="w-[90%] md:w-[80%] lg:w-[70%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12">
        <div>
          <h2
            data-aos="fade-up"
            className="py-3 text-3xl md:text-4xl font-bold tracking-tight text-transparent bg-clip-text bg-linear-to-r from-indigo-500 to-gray-300"
          >
          ...
          <p
            data-aos="fade-up"
            data-aos-delay="100"
            className="text-gray-400 mb-10 text-base lg:text-lg leading-relaxed"
          >
        ...
        <div data-aos="fade-left">
          <form className="rounded-lg bg-slate-900 px-4 py-8">
            ...
            />
            <button
              className="w-full bg-linear-to-r from-blue-900 to-purple-900 hover:from-blue-800 hover:to-purple-700 text-white font-semibold py-4 rounded-lg transition-all flex items-center justify-center gap-2 cursor-pointer disabled:cursor-not-allowed disabled:opacity-70"
            >
              <LuSend size={20} />
              Send Message
            </button>
